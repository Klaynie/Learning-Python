"""
Solution taken from Damian Ankudowicz
https://github.com/debitCredit 
https://hyperskill.org/profile/77345863
"""
    ...
    def __matmul__(self, other):
        if isinstance(other, Matrix):
            if self.cols != other.rows:
                ...
                result = []
                other_matrix_items = [
                    [item[i] for item in other.matrix] for i in range(other.cols)]
...
def print_prompt():
    ...
    func_choices = {'1': add_matrices, '2': mult_matrix_constant,
                    '3': mult_matrices, '4': transpose, '0': shutdown}
    func_choices.get(choice, incorrect_input)()


def add_matrices():
    matrix1, matrix2 = Matrix(init_matrix(
        " first")), Matrix(init_matrix(" second"))
